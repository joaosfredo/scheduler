<?php
/* Smarty version 3.1.34-dev-7, created on 2019-12-09 19:37:42
  from 'C:\xampp\htdocs\scheduler\views\ingles.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5dee9476556d22_08644486',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fb53acb2583694c61510fb6c31bbac68173d2835' => 
    array (
      0 => 'C:\\xampp\\htdocs\\scheduler\\views\\ingles.html',
      1 => 1575898434,
      2 => 'file',
    ),
  ),
...
function content_5dee9476556d22_08644486 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<html lang="pt-br">
         ...
         <div class="container">
           <div class="row align-items-center ">
             ...
             <div class="col-md-5 mt-5 pt-5">
               ...
               <p></p>
               <h1 class="mb-3 font-weight-bold text-teal">Inglês</h1>
             </div>
...
">
        ...
        <div class="card-body">
          <blockquote class="blockquote mb-0">
            <h4>Em qual das alternativas a seguir o advérbio está incorreto?</h4>
            <div class="form-check">
            <input class="form-check-input" type="radio" name="q1" id="exampleRadios1" value="0">
            <label class="form-check-label" for="exampleRadios1">
             <h5>She hasn’t met them yet.</h5>
            </label>
          </div>
          <div class="form-check">
            <input class="form-check-input" type="radio" name="q1" id="exampleRadios2" value="0">
            <label class="form-check-label" for="exampleRadios2">
              <h5>We were rather hot yesterday.</h5>
            </label>
          </div>
          <div class="form-check">
              <input class="form-check-input" type="radio" name="q1" id="exampleRadios1" value="1">
              <label class="form-check-label" for="exampleRadios1">
                  <h5>Jamie is waiting for us always.</h5>
              </label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="q1" id="exampleRadios2" value="0">
              <label class="form-check-label" for="exampleRadios2">
                  <h5>They work very hardly on Fridays.</h5>
              </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="q1" id="exampleRadios2" value="0">
                <label class="form-check-label" for="exampleRadios2">
                    <h5>My parents will travel by airplane.</h5>
                </label>
              </div>
          </blockquote>
        </div>
...
">
       ...
       <div class="card-body">
         <blockquote class="blockquote mb-0">
           <h4>Marque a alternativa correta que preenche a lacuna da seguinte frase: I know Alice _______ in the garden at this moment.</h4>
           <div class="form-check">
         ...
         <div class="form-check">
           <input class="form-check-input" type="radio" name="q3" id="exampleRadios2" value="1">
           <label class="form-check-label" for="exampleRadios2">
             <h5>is working</h5>
           </label>
         </div>
...
">
       ...
       <div class="card-body">
         <blockquote class="blockquote mb-0">
           <h4>They had ___ arrived when they were told to go back to their houses again.</h4>
           <div class="form-check">
           <input class="form-check-input" type="radio" name="q4" id="exampleRadios1" value="1">
           <label class="form-check-label" for="exampleRadios1">
            <h5>already</h5>
           </label>
         </div>
...
">
       ...
       <div class="card-body">
         <blockquote class="blockquote mb-0">
           <h4>Complete the following sentences with the correct option:<br>
                <br>
                The captain arrived with then members of his _____________.<br>
                My dream is to see the ____________ of lions.<br>
                I want to go to Africa so I could approach the ________________ of elephants there.<br>
                My boyfriend gave me a ___________ of red roses.<br>
                <br>
                </h4>
           <div class="form-check">
           <input class="form-check-input" type="radio" name="q5" id="exampleRadios1" value="0">
           <label class="form-check-label" for="exampleRadios1">
            <h5>crew, litter, pride, bouquet.</h5>
           </label>
         </div>
         <div class="form-check">
           <input class="form-check-input" type="radio" name="q5" id="exampleRadios2" value="0">
           <label class="form-check-label" for="exampleRadios2">
             <h5>litter, pride, archipelago, bouquet.</h5>
           </label>
         </div>
         <div class="form-check">
             <input class="form-check-input" type="radio" name="q5" id="exampleRadios1" value="1">
             <label class="form-check-label" for="exampleRadios1">
              <h5>crew, pride, herd, bouquet.</h5>
             </label>
           </div>
           <div class="form-check">
             <input class="form-check-input" type="radio" name="q5" id="exampleRadios2" value="0">
             <label class="form-check-label" for="exampleRadios2">
              <h5>pride, herd, crew, bouquet.</h5>
             </label>
           </div>
           <div class="form-check">
               <input class="form-check-input" type="radio" name="q5" id="exampleRadios2" value="0">
               <label class="form-check-label" for="exampleRadios2">
                <h5>herd, pride, litter, bouquet.</h5>
               </label>
             </div>
         </blockquote>
       </div>
...
">
       ...
       <div class="card-body">
         <blockquote class="blockquote mb-0">
           <h4>(UNIOESTE) Assinale a alternativa que expressa uma comparação de igualdade.</h4>
           <div class="form-check">
           <input class="form-check-input" type="radio" name="q6" id="exampleRadios1" value="0">
           <label class="form-check-label" for="exampleRadios1">
            <h5>We are the world's leading producer.</h5>
           </label>
         </div>
         <div class="form-check">
           <input class="form-check-input" type="radio" name="q6" id="exampleRadios2" value="0">
           <label class="form-check-label" for="exampleRadios2">
             <h5>You used to wait years to have a telephone installed.</h5>
           </label>
         </div>
         <div class="form-check">
             <input class="form-check-input" type="radio" name="q6" id="exampleRadios1" value="0">
             <label class="form-check-label" for="exampleRadios1">
              <h5>These resources are no longer exploited at the cost of the environment.</h5>
             </label>
           </div>
           <div class="form-check">
             <input class="form-check-input" type="radio" name="q6" id="exampleRadios2" value="1">
             <label class="form-check-label" for="exampleRadios2">
              <h5>Brazilians are as technology-hungry as anywhere in the world.</h5>
             </label>
           </div>
           <div class="form-check">
               <input class="form-check-input" type="radio" name="q6" id="exampleRadios2" value="0">
               <label class="form-check-label" for="exampleRadios2">
              <h5>We are the world's largest producer of sugar.</h5>
               </label>
             </div>
         </blockquote>
       </div>
...
">
       ...
       <div class="card-body">
         <blockquote class="blockquote mb-0">
           <h4>(FATEC) Das frases reproduzidas a seguir, aquela que traz exemplos de graus de comparação está na alternativa:</h4>
           <div class="form-check">
           <input class="form-check-input" type="radio" name="q7" id="exampleRadios1" value="0">
           <label class="form-check-label" for="exampleRadios1">
            <h5>“Neither, in fact, are the programmers themselves, who have grown up writing softwares to run on a single engine – serially, that is, not in parallel”.</h5>
           </label>
         </div>
         <div class="form-check">
           <input class="form-check-input" type="radio" name="q7" id="exampleRadios2" value="0">
           <label class="form-check-label" for="exampleRadios2">
             <h5>"For 50 years we've done things one way, and now we're changing to a different model".</h5>
           </label>
         </div>
         <div class="form-check">
             <input class="form-check-input" type="radio" name="q7" id="exampleRadios1" value="1">
             <label class="form-check-label" for="exampleRadios1">
              <h5>"Moore's Law has held true, making computers cheaper and faster and more powerful".</h5>
             </label>
           </div>
           <div class="form-check">
             <input class="form-check-input" type="radio" name="q7" id="exampleRadios2" value="0">
             <label class="form-check-label" for="exampleRadios2">
              <h5>"Writing programs for them is incredibly difficult and time consuming".</h5>
             </label>
           </div>
           <div class="form-check">
               <input class="form-check-input" type="radio" name="q7" id="exampleRadios2" value="0">
               <label class="form-check-label" for="exampleRadios2">
              <h5>"Within a decade we will likely see chips with 100 cores, maybe even more, Rattner says".</h5>
               </label>
             </div>
         </blockquote>
       </div>
...
">
       ...
       <div class="card-body">
         <blockquote class="blockquote mb-0">
           <h4>Sobre os “Collective Nouns”, é correto afirmar que:</h4>
           <div class="form-check">
           <input class="form-check-input" type="radio" name="q8" id="exampleRadios1" value="0">
           <label class="form-check-label" for="exampleRadios1">
            <h5>The group of nouns that describe or modify another person or thing in the sentence.</h5>
           </label>
         </div>
         <div class="form-check">
           <input class="form-check-input" type="radio" name="q8" id="exampleRadios2" value="1">
           <label class="form-check-label" for="exampleRadios2">
             <h5>The group of nouns that refers to a class or group of something it can be a group of person, class of animals or even things.</h5>
           </label>
         </div>
         <div class="form-check">
             <input class="form-check-input" type="radio" name="q8" id="exampleRadios1" value="0">
             <label class="form-check-label" for="exampleRadios1">
              <h5>The group of nouns that any member of a class of words that function as the main elements of predicates, that typically express action, state, or a relation betweentwo things.</h5>
             </label>
           </div>
           <div class="form-check">
             <input class="form-check-input" type="radio" name="q8" id="exampleRadios2" value="0">
             <label class="form-check-label" for="exampleRadios2">
              <h5>The group of nouns that containing a subject and verb acts as an adverb.</h5>
             </label>
           </div>
           <div class="form-check">
               <input class="form-check-input" type="radio" name="q8" id="exampleRadios2" value="0">
               <label class="form-check-label" for="exampleRadios2">
              <h5>The group of nouns that which come at the beginning of the noun phrase.</h5>
               </label>
             </div>
         </blockquote>
       </div>
...
">
       ...
       <div class="card-body">
         <blockquote class="blockquote mb-0">
           <h4>Complete the empt spaces with the rigth option:<br><br>
                My sister has a ___________of keys.<br>
                There was a _____________ of camels here before you arrive.<br>
                A _________ of birds are flying north.<br>
                I have a of___________ cats at my house.<br><br>

           </h4>
           <div class="form-check">
           <input class="form-check-input" type="radio" name="q9" id="exampleRadios1" value="0">
           <label class="form-check-label" for="exampleRadios1">
            <h5>troop, school, herd,caravan.</h5>
           </label>
         </div>
         <div class="form-check">
           <input class="form-check-input" type="radio" name="q9" id="exampleRadios2" value="0">
           <label class="form-check-label" for="exampleRadios2">
             <h5>pack, caravan, cluster, flocks.</h5>
           </label>
         </div>
         <div class="form-check">
             <input class="form-check-input" type="radio" name="q9" id="exampleRadios1" value="0">
             <label class="form-check-label" for="exampleRadios1">
              <h5>brunch, school, flocks, pack.</h5>
             </label>
           </div>
           <div class="form-check">
             <input class="form-check-input" type="radio" name="q9" id="exampleRadios2" value="1">
             <label class="form-check-label" for="exampleRadios2">
              <h5>ring, caravan, flocks, clowder.</h5>
             </label>
           </div>
           <div class="form-check">
               <input class="form-check-input" type="radio" name="q9" id="exampleRadios2" value="0">
               <label class="form-check-label" for="exampleRadios2">
              <h5>ring, flocks, caravan, clowder.</h5>
               </label>
             </div>
         </blockquote>
       </div>
...
">
       ...
       <div class="card-body">
         <blockquote class="blockquote mb-0">
           <h4>Mark the incorrect alternative:</h4>
           <div class="form-check">
           <input class="form-check-input" type="radio" name="q10" id="exampleRadios1" value="0">
           <label class="form-check-label" for="exampleRadios1">
            <h5>We're a team, and we'll win this game.</h5>
           </label>
         </div>
         <div class="form-check">
           <input class="form-check-input" type="radio" name="q10" id="exampleRadios2" value="0">
           <label class="form-check-label" for="exampleRadios2">
             <h5>I love the cast of the movie Pride and Prejudice, they're all fantastic, they gave life to the characters from the book.</h5>
           </label>
         </div>
         <div class="form-check">
             <input class="form-check-input" type="radio" name="q10" id="exampleRadios1" value="0">
             <label class="form-check-label" for="exampleRadios1">
              <h5>There was a caravan of camels here before you arrive.</h5>
             </label>
           </div>
           <div class="form-check">
             <input class="form-check-input" type="radio" name="q10" id="exampleRadios2" value="0">
             <label class="form-check-label" for="exampleRadios2">
              <h5>My dream is have my own library at home!</h5>
             </label>
           </div>
           <div class="form-check">
               <input class="form-check-input" type="radio" name="q10" id="exampleRadios2" value="1">
               <label class="form-check-label" for="exampleRadios2">
              <h5>You need to organizer this pile of dogs in your home.</h5>
               </label>
             </div>
           </blockquote>
         </div>
