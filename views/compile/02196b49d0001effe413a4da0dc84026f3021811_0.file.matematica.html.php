<?php
/* Smarty version 3.1.34-dev-7, created on 2019-12-09 19:43:45
  from 'C:\xampp\htdocs\scheduler\views\matematica.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5dee95e189b518_56558089',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '02196b49d0001effe413a4da0dc84026f3021811' => 
    array (
      0 => 'C:\\xampp\\htdocs\\scheduler\\views\\matematica.html',
      1 => 1575898432,
      2 => 'file',
    ),
  ),
...
function content_5dee95e189b518_56558089 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<html lang="pt-br">
         ...
         <div class="container">
           <div class="row align-items-center ">
             ...
             <div class="col-md-5 mt-5 pt-5">
               ...
               <p></p>
               <h1 class="mb-3 font-weight-bold text-teal">Matemática</h1>
             </div>
...
<form method="POST" action="<?php echo $_smarty_tpl->tpl_vars['SOMA']->value;?>
">
<!-- Questão 1 -->
     <div class="container">
     <div class="card questoes">
...
">
        ...
        <div class="card-body">
          <blockquote class="blockquote mb-0">
            <h4>(PUC-RIO 2009) Temos uma progressão aritmética de 20 termos onde o 1º termo é igual a 5. A soma de todos os termos dessa progressão aritmética é 480. O décimo termo é igual a:</h4>
          ...
          <div class="form-check">
            ...
            <div class="form-check">
              ...
              <label value="0" class="form-check-label" for="exampleRadios2">
                  <h5>23</h5>
              </label>
            </div>
            <div class="form-check">
...
">
       ...
       <div class="card-body">
         <blockquote class="blockquote mb-0">
           <h4>(PUC-RIO 2010)
              Em uma turma de Ciências da Computação formada de 40 rapazes e 40 moças, tem-se a seguinte estatística: 20% dos rapazes são fumantes; 30% das moças são fumantes. Logo, a porcentagem dos que não fumam na turma é de:</h4>
           <div class="form-check">
...
">
       ...
       <div class="card-body">
         <blockquote class="blockquote mb-0">
           <h4>(UFPR 2009)
              Sabendo-se que x = 2 é um zero do polinômio p(x) = 9x³ − 21x² + 4x + 4, é correto afirmar que a soma das outras duas raízes é igual a:</h4>
           <div class="form-check">
...
">
       ...
       <div class="card-body">
         <blockquote class="blockquote mb-0">
           <h4>(UFRGS 2017)
              Considere o polinômio p definido por p(x) = x2 + 2(n + 2)x + 9n. Se as raízes de p(x) = 0 são iguais, os valores de n são:</h4>
           <div class="form-check">
         ...
         <div class="form-check">
             ...
             <label value="0" class="form-check-label" for="exampleRadios1">
              <h5>-1 e 4</h5>
             </label>
           </div>
           <div class="form-check">
...
">
       ...
       <div class="card-body">
         <blockquote class="blockquote mb-0">
           <h4>(PUC-RIO 2009)
              Comprando dois milk shakes e um bolo gastamos R$13,00. Comprando um milk shake e dois bolos gastamos R$11,00. Quanto gastamos comprando um milk shake e um bolo?</h4>
           <div class="form-check">
         ...
         <div class="form-check">
             ...
             <label value="1" class="form-check-label" for="exampleRadios1">
              <h5>R$ 8,00</h5>
             </label>
           </div>
           <div class="form-check">
...
">
       ...
       <div class="card-body">
         <blockquote class="blockquote mb-0">
           <h4>(UFRGS 2017) Se x – y = 2 e x2 + y2 = 8, então x3 – y3 é igual a:</h4>
           <div class="form-check">
         ...
         <div class="form-check">
           ...
           <div class="form-check">
               ...
               <label value="1" class="form-check-label" for="exampleRadios2">
              <h5>20</h5>
               </label>
             </div>
         </blockquote>
...
">
       ...
       <div class="card-body">
         <blockquote class="blockquote mb-0">
           <h4>(UECE 2018.1 - 1ª Fase) A soma de todas as frações da forma n/(n+1), onde n é um elemento do conjunto [1, 2, 3, 4, 5], é:</h4>
           <div class="form-check">
...
">
       ...
       <div class="card-body">
         <blockquote class="blockquote mb-0">
           <h4>(FUVEST 2016)
              Os pontos A, B e C são colineares, AB = 5, BC = 2 e B está entre A e C. Os pontos C e D pertencem a uma circunferência com centro em A. Traça-se uma reta  perpendicular ao segmento BD passando pelo seu ponto médio. Chama-se de P a interseção de R com AD. Então, AP + BP vale:</h4>
           <div class="form-check">
       ...
       <div class="card-body">
         <blockquote class="blockquote mb-0">
           <h4>(Enem 2012)
              ...
              A variância das produções dos talhões expressa em (sacas/hectare)2 é</h4>
